...
//		setBorder(BorderFactory.createMatteBorder(2, 2, 2, 2, CommonUtil.getColor(Music.getConfigMap().get("border.color").toString(),50)));
//		setBorder(BorderFactory.createLoweredBevelBorder());
		setBorder(BorderFactory.createBevelBorder(BevelBorder.RAISED, new Color(128,128,128,50),	new Color(128,128,128,50)));
	}
	...
	public void paint(Graphics g) {
		...
		RoundRectangle2D rect=new RoundRectangle2D.Double(0,0,this.getWidth(),getHeight(),5,5);
