...
public class PlayListService extends MusicService {
	...
	public PlayListService() {
		if(null == playLists || playLists.size() <= 0){
			...
			pl.setFileName(PLAYLIST_DEFAULT_FILE_NAME);
			pl.setPlayListName(getConfigMap().get("play.list.default.name").toString());
			playLists.add(pl);
			PlayList pl1 = new PlayList() ;
			pl1.setFileName(PLAYLIST_LATELY_FILE_NAME);
			pl1.setPlayListName(getConfigMap().get("play.list.lately.name").toString());
			playLists.add(pl1);
		}
	}
