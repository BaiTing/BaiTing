 ...
 */
package com.baiting.action;

import java.io.IOException;

import com.baiting.decoder.Header;
import com.baiting.decoder.IAudio;
import com.baiting.decoder.ID3Tag;
import com.baiting.decoder.Layer123;
import com.baiting.instream.BuffRandReadFile;
import com.baiting.instream.BuffRandReadURL;
import com.baiting.instream.MultiplexAudio;
import com.baiting.instream.RandomRead;
...
//			audio.close();
	...
	public boolean open(String name, String title) throws IOException {
		...
		if (str.startsWith("http://") && str.indexOf(".mp3") != -1) {
			instream = new BuffRandReadURL();
