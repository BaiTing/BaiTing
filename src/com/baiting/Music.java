...
//	protected static int netSongType = 1;
	...
	public Music() {
		...
		if(null != CONFIG_MAP) {
			playListName = getConfigMap().get("play.list.lately.name").toString();
		}
	}
	...
	public static Color getPlayListSelectionBackground(int apal) {
		return CommonUtil.getColor("#CA9990",apal);
	}
	
	public static Color getPlayListSelectionBackground() {
		return getPlayListSelectionBackground(255);
	}
	
	public static Color getPlayListSelectionForeground(int apal) {
		return CommonUtil.getColor("#FFFFFF",apal);
	}
	
	public static Color getPlayListSelectionForeground() {
		return getPlayListSelectionForeground(255);
	}
	
	public static Color getSongListSelectionBackground(int apal) {
		return CommonUtil.getColor("#ECDBD8", apal);
	}
	
	public static Color getSongListSelectionBackground() {
		return getSongListSelectionBackground(255) ;
	}
	
	public static Color getSongListSelectionForeground(int apal) {
		return CommonUtil.getColor("#226699", apal);
	}
	
	public static Color getSongListSelectionForeground() {
		return getSongListSelectionForeground(255);
	}
