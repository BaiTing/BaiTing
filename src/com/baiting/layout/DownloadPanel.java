...
public class DownloadPanel extends Music{
	...
	private void init() {
		if(panel == null) {
			...
			downLeftPanel.setBorder(BorderFactory.createMatteBorder(0, 1, 0, 1, CommonUtil.getColor(getConfigMap().get("down.left.panel.border.color").toString(), 100)));
...
//			panel.add(downLeftPanel,BorderLayout.WEST);
			panel.add(downLeftPanel,BorderLayout.EAST);
	...
	private void setDownLeftPanelLayout() {
		...
		downTitlePanel.setOpaque(false);
//		downTitlePanel.setBackground(CommonUtil.getColor(getConfigMap().get("down.panel.title.background.color").toString()));
		downTitlePanel.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, CommonUtil.getColor("#C5948C", 100)));
...
//		downingLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.background.color").toString()));
		...
		downingLabel.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, CommonUtil.getColor(getConfigMap().get("downing.label.border.color").toString(), 100)));
		downingTable();
		
		downedLabel = new JLabel();
		downedLabel.setText(getConfigMap().get("downed.info.label").toString());
		downedLabel.setOpaque(false);
...
//		downedLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downed.label.background.color").toString()));
		...
		downedLabel.setBorder(BorderFactory.createMatteBorder(1, 0, 1, 0, CommonUtil.getColor(getConfigMap().get("downed.label.border.color").toString(),100)));
		
		downFailLabel = new JLabel();
		downFailLabel.setText(getConfigMap().get("down.fail.info.label").toString());
		downFailLabel.setOpaque(false);
...
//		downFailLabel.setBackground(CommonUtil.getColor(getConfigMap().get("down.fail.label.background.color").toString()));
		...
		downFailLabel.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, CommonUtil.getColor(getConfigMap().get("down.fail.label.border.color").toString(),100)));
		...
		downingLabel.addMouseListener(new MusicMouseListener() {
			...
			public void mouseExited(MouseEvent e) {
				if(downingClick == 0) {
					downingLabel.setOpaque(false);
					downingLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.mouseExited.background.color").toString(),100));
			...
			public void mouseEntered(MouseEvent e) {
				if(downingClick == 0) {
					...
					downingLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.mouseEntered.background.color").toString(),100));
					nameTabPanel.repaint();
				}
			}
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getButton() == MouseEvent.BUTTON1) {
					downingClick = 1;
					downingLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.background.color").toString(),100));
					downingLabel.setFont(Fonts.songTiB13());
					
					downedClick = 0;
					downedLabel.setOpaque(false);
//					downedLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downed.label.background.color").toString(),100));
					downedLabel.setFont(Fonts.songTi13());
						
					downFailClick = 0;
					downFailLabel.setOpaque(false);
//					downFailLabel.setBackground(CommonUtil.getColor(getConfigMap().get("down.fail.label.background.color").toString(),100));
					downFailLabel.setFont(Fonts.songTi13());
					if(downloadType != 1) {
					  downloadType = 1;
					  downingTable();
		...
		downedLabel.addMouseListener(new MusicMouseListener() {
			...
			public void mouseEntered(MouseEvent e) {
				if(downedClick == 0) {
					...
					downedLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.mouseEntered.background.color").toString(),100));
					nameTabPanel.repaint();
				}
			}
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getButton() == MouseEvent.BUTTON1) {
					downedClick = 1;
					downedLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.background.color").toString(),100));
					downedLabel.setFont(Fonts.songTiB13());
						
					downingClick = 0;
					downingLabel.setOpaque(false);
//					downingLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downed.label.background.color").toString(),100));
					downingLabel.setFont(Fonts.songTi13());
						
					downFailClick = 0;
					downFailLabel.setOpaque(false);
//					downFailLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downed.label.background.color").toString(),100));
					downFailLabel.setFont(Fonts.songTi13());
					if(downloadType != 2) {
						downloadType = 2;
						downedTable();
		...
		downFailLabel.addMouseListener(new MusicMouseListener() {
			...
			public void mouseEntered(MouseEvent e) {
				if(downFailClick == 0) {
					...
					downFailLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.mouseEntered.background.color").toString(),100));
					nameTabPanel.repaint();
				}
			}
			...
			public void mouseClicked(MouseEvent e) {
				if(e.getButton() == MouseEvent.BUTTON1) {
					downFailClick = 1;
					downFailLabel.setBackground(CommonUtil.getColor(getConfigMap().get("downing.label.background.color").toString(),100));
