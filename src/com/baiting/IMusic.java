...
public interface IMusic {
	...
	public final static String PLAYLIST_DEFAULT_FILE_NAME = "default"; //默认播放列表
	
	public final static String PLAYLIST_LATELY_FILE_NAME = "lately"; //最近播放列表
...
//	public final static int NET_SONG_LIST_NET = 4;
	 ...
	 * 搜索
	 */
	public final static int NET_SONG_LIST_SEARCH = 0;
